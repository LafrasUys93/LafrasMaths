...
function header_div(){
    ...
    sitenameheader_div.style.position = "relative";
    sitenameheader_div.style.zIndex = "2";
    ...
    sitenameheader_title.textContent = "MathHub";
...
function language_div(){
    ...
    language_div.style.position = "relative";
    language_div.style.zIndex = "2";
...
function chooseLanguage(language){
    ...
    if (language == "Afrikaans"){
        ...
        mainPageAfrikaans.style.zIndex = "2"
        mainPageAfrikaans.style.position = "relative"
        ...
        mainPageEnglish.style.position = "relative"
        mainPageEnglish.style.zIndex = "2"
    };
}
function image_div(){
    ...
    imageDiv.style.backgroundImage = 'url("Background MathHub.jpg")'
    //imageDiv.style.zIndex = "1"
    //imageDiv.style.height = "40em"
    //imageDiv.style.width = "40em"
